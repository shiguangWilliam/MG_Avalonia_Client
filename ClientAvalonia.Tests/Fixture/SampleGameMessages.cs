...
/// Field order is locked by <see cref="DxAliases"/>.
///
/// Tests should call <see cref="BuildGameMessage"/> rather than hand-typing CTCP —
/// that keeps the field order under a single choke point.
/// </summary>
