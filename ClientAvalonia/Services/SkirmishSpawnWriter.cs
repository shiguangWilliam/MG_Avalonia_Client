...
public static class SkirmishSpawnWriter
{
        ...
        int randomSeed)
    {
        ...
        settings.SetIntValue("Side", localPlayer.SideIndex);
        settings.SetBooleanValue("IsSpectator", false);
        settings.SetIntValue("Color", localPlayer.ColorIndex);
        settings.SetStringValue("CustomLoadScreen", LoadingScreenController.GetLoadScreenName(localPlayer.SideIndex.ToString()));
        ...
        foreach (LobbyPlayerSlot human in humans)
        {
            ...
            spawnIni.SetIntValue(sectionName, "Side", human.SideIndex);
            spawnIni.SetBooleanValue(sectionName, "IsSpectator", false);
            spawnIni.SetIntValue(sectionName, "Color", human.ColorIndex);
            otherId++;
        }
        ...
        for (int aiId = 0; aiId < ais.Count; aiId++)
        {
            ...
            spawnIni.SetIntValue("HouseCountries", keyName, ais[aiId].SideIndex);
            spawnIni.SetIntValue("HouseColors", keyName, ais[aiId].ColorIndex);
        }
